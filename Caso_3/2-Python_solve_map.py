...
environment_size=[300,300] ### size in cm

####-----------------Input Data-----------------
imagen=r"Caso_3\CCE_3.jpg"
n_obstacles=20
slope1=1
slope2=4
rad_hyper=0.1
init_point=[0,0]   ## [x,y] pos
end_point=[590,590]
n_hyper_max=15000
file_slopes=r"Caso_3\slopes.txt"
...
# obstacles data
ruta_obstaculos = r"Caso_3\obstacles.txt"

# homotopy tool path
ruta_exe = r"Caso_3\p_trayectoria.exe"

# output data
ruta_datos = r"Caso_3\tray.txt"
